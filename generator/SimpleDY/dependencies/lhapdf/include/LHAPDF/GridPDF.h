...
namespace LHAPDF {
  ...
  public:
    ...
    /// Access to the data structure (generic alias)
    ///
    /// @todo Eliminate the non-standard function capitalisation: requires a rename as direct access to `data` already exists
    KnotArray& Data() {
      return data;
    }
